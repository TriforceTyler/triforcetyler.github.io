    ...
    var n = s(function(t, s) {
        (function() {
            ...
            (function(e) {
                ...
                easeInOutElastic: function(t, e, s, n) {
                    ...
                    (i = s) < Math.abs(s) ? (i = s,
                    o = a / 4) : o = a / (2 * Math.PI) * Math.asin(s / i),
                    t < 1 ? i * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * n - o) * (2 * Math.PI) / a) * -.5 + e : i * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * n - o) * (2 * Math.PI) / a) * .5 + s + e
                },
                ...
                easeOutBack: function(t, e, s, n, i) {
                    return void 0 === i && (i = 1.70158),
                    s * ((t = t / n - 1) * t * ((i + 1) * t + i) + 1) + e
                },
                easeInOutBack: function(t, e, s, n, i) {
                    return void 0 === i && (i = 1.70158),
                    (t /= n / 2) < 1 ? s / 2 * (t * t * ((1 + (i *= 1.525)) * t - i)) + e : s / 2 * ((t -= 2) * t * ((1 + (i *= 1.525)) * t + i) + 2) + e
                },
      ...
      , i = s(function(t) {
        ...
        function a(t, e, n, a, o) {
            ...
            var r = new i(n,a || t,o)
              , h = s ? s + e : e;
            return t._events[h] ? t._events[h].fn ? t._events[h] = [t._events[h], r] : t._events[h].push(r) : (t._events[h] = r,
            t._eventsCount++),
            t
        }
        function o(t, e) {
        ...
        r.prototype.eventNames = function() {
            ...
            for (n in t = this._events)
                e.call(t, n) && i.push(s ? n.slice(1) : n);
        ...
        r.prototype.emit = function(t, e, n, i, a, o) {
            ...
            if (c.fn) {
                ...
                case 4:
                    ...
                    !0;
                case 5:
                    return c.fn.call(c.context, e, n, i, a),
                    !0;
                case 6:
                    return c.fn.call(c.context, e, n, i, a, o),
                    !0
                }
                for (u = 1,
                h = new Array(l - 1); u < l; u++)
                    h[u - 1] = arguments[u];
        ...
        r.prototype.removeListener = function(t, e, n, i) {
            ...
            if (r.fn)
                r.fn !== e || i && !r.once || n && r.context !== n || o(this, a);
            else {
        ...
        remove(t, e) {
            if (0 === arguments.length)
                ...
                for (let s = 0; s < this.eases.length; s++) {
                    ...
                    t && n.element !== t || e && -1 === e.indexOf(n.entry) || (this.eases.splice(s, 1),
                    s--)
                }
            }
    ...
    class r extends i {
        ...
        removeEase(t, e) {
            for (let s = 0; s < this.easings.length; s++)
                this.easings[s].remove(t, e) && (this.easings.splice(s, 1),
                s--);
        ...
        update(t) {
            ...
            !this.empty) {
                ...
                for (let s of e)
                    s.update(t) && this.easings.splice(this.easings.indexOf(s), 1);
                this.emit("each", this),
                0 === this.easings.length && (this.empty = !0,
                this.emit("complete", this))
            }
